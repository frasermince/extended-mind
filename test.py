...
def test_config():
    """
    Returns a minimal OmegaConf config object tailored for testing.
    It mirrors the expected structure of the main config.yaml used during training/evaluation.
    """
    cfg_dict = {
        "training": {
        ...
        # Top-level aliases used directly by some helper functions
        # "env_id": "MiniGrid-SaltAndPepper-v0-custom",
        "seed": 42,
        "eval": True,
        "eval_episodes": 1,
